  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">Calendar Integration</h3>
      ...
      {integrations.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 max-w-md mx-auto">
            Connect your Google Calendar to automatically sync tasks and stay organized across all your platforms.
          </p>
        </div>
      )}
    </div>
